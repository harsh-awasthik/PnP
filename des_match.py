...
w1 = img1.shape[1]
h1 = img1.shape[0]
x, y, w, h = int(w1/3), int(2 * h1/5), int(w1/3), int(h1/5)  # Example coordinates for the rectangle
...
w2 = img2.shape[1]
h2 = img2.shape[0]
x, y, w, h = int(w2/3), int(2*h2/3), int(w2/3), int(h2/5)  # Example coordinates for the rectangle
